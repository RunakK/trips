...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var hero = new Swiper('.hero__swiper', {
    // Optional parameters
  ...
  var tours = new Swiper('.tours__swiper', {
    // Optional parameters
    direction: 'horizontal',
    loop: false,
    slidesPerView: 1,
  ...
  var instructors = new Swiper('.instructors__swiper', {
    // Optional parameters
    direction: 'horizontal',
    loop: false,
    slidesPerView: 1,
  ...
  var gallery = new Swiper('.gallery__swiper', {
    // Optional parameters
    direction: 'horizontal',
    loop: false,
    slidesPerView: 1,
  ...
  var map = L.map('map').setView([55.774836, 37.632664], 18);
  ...
  var video = document.querySelector('.hero__video-button');
  var mediaBlock = document.querySelector('.hero__video');
...
},{"./modules/form-validate/form":3,"./modules/header":11,"./utils/ios-vh-fix":16}],2:[function(require,module,exports){
"use strict";
...
},{"./burger":9,"./sticky-header":14}],12:[function(require,module,exports){
"use strict";
